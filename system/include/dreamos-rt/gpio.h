...
#define GPIO_MODE_SPEED_Msk	(0x3 << GPIO_MODE_TYPE_Pos)
#define GPIO_MODE_SPEED_LO	(0 << GPIO_MODE_TYPE_Pos)
#define GPIO_MODE_SPEED_MID	(1 << GPIO_MODE_TYPE_Pos)
#define GPIO_MODE_SPEED_HI	(3 << GPIO_MODE_TYPE_Pos)
